    ...
    public partial class TrnPOSBarcodeDetailForm : Form
    {
            ...
            if (salesLineList.Any())
            {
                ...
                foreach (var objSalesLineList in salesLineList)
                {
                    ...
                    dataGridViewSalesLineList.Rows.Add(
                        ...
                        objSalesLineList.TradeInNo,
                        objSalesLineList.TradeInAmount.ToString("#,##0.00"),
                        objSalesLineList.DefectiveId,
                        objSalesLineList.DefectiveNo,
                        objSalesLineList.DefectiveInvoiceNo,
        ...
        private void dataGridViewSalesLineList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1 && dataGridViewSalesLineList.CurrentCell.ColumnIndex == dataGridViewSalesLineList.Columns["ColumnSalesLineEdit"].Index)
            {
                ...
                Int32 TradeInId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[14].Value);
                Decimal TradeInAmount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[16].Value);
                Int32 DefectiveId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[17].Value);
                String DefectiveNo = DefectiveId > 0 ? dataGridViewSalesLineList.Rows[e.RowIndex].Cells[18].Value.ToString() : "";
                String DefectiveInvoiceNo = DefectiveId > 0 ? dataGridViewSalesLineList.Rows[e.RowIndex].Cells[19].Value.ToString() : "";
                Int32 DiscountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[20].Value);
                String Discount = dataGridViewSalesLineList.Rows[e.RowIndex].Cells[21].Value.ToString(); ;
                Decimal DiscountRate = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[22].Value);
                Decimal DiscountAmount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[23].Value);
                Int32 TaxId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[24].Value);
                String Tax = dataGridViewSalesLineList.Rows[e.RowIndex].Cells[25].Value.ToString();
                Decimal TaxRate = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[26].Value);
                Decimal TaxAmount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[27].Value);
                Int32 SalesAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[28].Value);
                Int32 AssetAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[29].Value);
                Int32 CostAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[30].Value);
                Int32 TaxAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[31].Value);
                String SalesLineTimeStamp = dataGridViewSalesLineList.Rows[e.RowIndex].Cells[32].Value.ToString();
                Int32 UserId = Convert.ToInt32(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[33].Value);
                String Preparation = dataGridViewSalesLineList.Rows[e.RowIndex].Cells[34].Value.ToString();
                Decimal Price1 = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[35].Value);
                Decimal Price2 = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[36].Value);
                Decimal Price2LessTax = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[37].Value);
                Decimal PriceSplitPercentage = Convert.ToDecimal(dataGridViewSalesLineList.Rows[e.RowIndex].Cells[38].Value);
                ...
                Entities.TrnSalesLineEntity trnSalesLineEntity = new Entities.TrnSalesLineEntity()
                {
                    ...
                    DefectiveInvoiceNo = DefectiveInvoiceNo
                };
        ...
        private void dataGridViewSalesLineList_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    Int32 UnitId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[8].Value);
                    String Unit = dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[9].Value.ToString();
                    Decimal Price = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[10].Value);
                    Int32 DiscountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[11].Value);
                    String Discount = dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[12].Value.ToString(); ;
                    Decimal DiscountRate = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[13].Value);
                    Decimal DiscountAmount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[14].Value);
                    Decimal NetPrice = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[15].Value);
                    Decimal Amount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[16].Value);
                    Int32 TaxId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[17].Value);
                    String Tax = dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[18].Value.ToString();
                    Decimal TaxRate = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[19].Value);
                    Decimal TaxAmount = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[20].Value);
                    Int32 SalesAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[21].Value);
                    Int32 AssetAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[22].Value);
                    Int32 CostAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[23].Value);
                    Int32 TaxAccountId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[24].Value);
                    String SalesLineTimeStamp = dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[25].Value.ToString();
                    Int32 UserId = Convert.ToInt32(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[26].Value);
                    String Preparation = dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[27].Value.ToString();
                    Decimal Price1 = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[28].Value);
                    Decimal Price2 = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[29].Value);
                    Decimal Price2LessTax = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[30].Value);
                    Decimal PriceSplitPercentage = Convert.ToDecimal(dataGridViewSalesLineList.Rows[dataGridViewSalesLineList.CurrentCell.RowIndex].Cells[31].Value);
